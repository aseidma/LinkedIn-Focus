...
const displayQuote = () => {
    ...
    const gsDonate = "You can support us as we build the software development ecosystem of the future by sponsoring us on GitHub and/or by making a donation via PayPal."
