...
var instruction = "To enable your news feed again, click on the "
...
function displayQuote(){
    ...
    const quoteStyle = "style=\"color:#293E4A;font-size:24px;\""
    const titleStyle = ""
    const quoteHTML = "<h1>LinkedInFocus</h1><p" + quoteStyle + ">" + quote.text + "- " + quote.source + "</p>"
    document.getElementsByClassName('core-rail')[0].innerHTML = quoteHTML
    document.getElementsByClassName('core-rail')[0].style.color = '#293E4A';
    document.getElementsByClassName('core-rail')[0].style.fontSize ="24px";
